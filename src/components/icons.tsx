...
export function Google(props: LucideProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M21.8 10.5H12v4h5.7c-.8 2.3-3 4-5.7 4-3.3 0-6-2.7-6-6s2.7-6 6-6c1.7 0 3.2.7 4.2 1.8l2.9-2.9C16.5 2.2 14.3 1 12 1 6.5 1 2 5.5 2 11s4.5 10 10 10 10-4.5 10-10c0-.7-.1-1.4-.2-2.1z" />
    </svg>
  );
}
