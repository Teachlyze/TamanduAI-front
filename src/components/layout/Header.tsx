'use client';
import { Info, Phone, LayoutDashboard, UserIcon, Menu, Shapes } from 'lucide-react';
  ...
  return (
    <header className="flex justify-between items-center p-2 bg-black text-white">
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        <Link
          href="/"
          className="flex items-center text-3xl font-medium drop-shadow-2xl cursor-pointer gap-4"
        >
          <Shapes className="p-1 bg-blue-500 rounded-sm" width={32} height={32} /> TamanduAI
        </Link>
        ...
        <div className="md:hidden ml-auto">
          ...
          <Sheet>
            ...
            <SheetContent
              side="left"
              className="px-2 bg-black text-white border-r-2 border-gray-400"
            >
